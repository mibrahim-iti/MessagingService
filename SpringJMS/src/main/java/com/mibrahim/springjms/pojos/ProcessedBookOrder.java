package com.mibrahim.springjms.pojos;
...
public class ProcessedBookOrder {
	...
	@JsonCreator
	public ProcessedBookOrder(@JsonProperty("bookOrder") BookOrder bookOrder, @JsonProperty("processingDateTime") Date processingDateTime,
	...
	public String toString() {
		return "ProcessedBookOrder{" + "bookOrder=" + bookOrder + ", processingDateTime=" + processingDateTime + ", expectedShippingDateTime="
