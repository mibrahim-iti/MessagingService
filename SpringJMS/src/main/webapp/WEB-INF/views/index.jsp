...
<div class="container">
	<div class="header clearfix">
		<nav>
			<ul class="nav nav-pills float-right">
				...
				<li class="nav-item"><a href="#" class="nav-link"> About <span
	...
	<div class="jumbotron row">
		<div class="col-lg-6">
			<img src="${contextPath}/images/random_books.png"
				style="width: 350px;" class="rounded" alt="picture of random books" />
		</div>
		<div class="col-lg-6">
			...
			<div class="col-lg-12">
				...
				<div class="input-group">
					<select class="form-control" id="customerId">
						<c:forEach var="item" items="${customers}">
							<option value="${item.customerId}">${item.customerId}-
				...
				<select class="form-control" id="bookId">
					<c:forEach var="item" items="${books}">
						<option value="${item.bookId}">${item.bookId}-
							${item.title}</option>
					</c:forEach>
				</select> <br />
				<h4>Order Status</h4>
				...
				<button class="btn btn-primary" id="addToOrderId"
					onclick="processOrder();" type="button">Add to Order</button>
...
<script>
	function processOrder() {
		...
		jQuery.get('${contextPath}/process/store/'
				+ randomStoreId + '/order/' + randomOrderId + '/' + customerId
				+ '/' + bookId + '/' + orderStateId + "/", function(data,
				status) {
...
<script type="text/javascript"
	src="${contextPath}/webjars/jquery/3.5.1/jquery.min.js"></script>
<script type="text/javascript"
	src="${contextPath}/webjars/bootstrap/4.5.0/js/bootstrap.min.js"></script>
